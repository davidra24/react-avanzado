...
define("./service-worker.js",['./workbox-d41f36cc'], function (workbox) { 'use strict';
  ...
  */
  ...
  workbox.precacheAndRoute([{
    "url": "/0.bundle.js",
    "revision": "8f6e7400dabec846f2b9083cac8cbf42"
  }, {
    "url": "/1.bundle.js",
    "revision": "65f1d3603c56bce6a945983998471e14"
  }, {
    ...
    "url": "/index.html",
    "revision": "a2d61f2cdbcf557412406db4237407fd"
  }, {
    "url": "/manifest.dc506b12897a08d407f79c28eecfaa64.json",
    "revision": "dc506b12897a08d407f79c28eecfaa64"
  }], {});
  workbox.registerRoute(/https:\/\/(res.cloudinary.com|images.unspalsh.com)/, new workbox.CacheFirst({
    "cacheName": "images",
    plugins: []
  }), 'GET');
  workbox.registerRoute(/https:\/\/(https:\/\/petgram-server-dramirez.cdavidramirezg24.now.sh)/, new workbox.NetworkFirst({
    "cacheName": "api",
    plugins: []
  }), 'GET');
